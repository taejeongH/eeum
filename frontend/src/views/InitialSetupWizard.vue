            ...
            <div class="bg-white rounded-3xl p-6 shadow-sm border border-slate-100">
              <div class="flex justify-between items-end mb-4">
                <div>
                  ...
                  <h3 class="text-2xl font-bold text-slate-900">{{ completedCount }} / {{ voiceSamples.length }}</h3>
                </div>
              ...
              <div class="w-full bg-slate-100 rounded-full h-2 overflow-hidden">
                <div class="bg-[var(--color-primary)] h-full rounded-full transition-all duration-500" :style="{ width: `${progressPercentage}%` }"></div>
              </div>
            </div>
              ...
              <div v-for="(sample, index) in voiceSamples" :key="sample.id" 
                ...
                <div class="flex-1 mr-4">
                  <div class="flex items-center gap-2 mb-1">
                    <span class="text-xs font-bold text-[var(--color-primary)] px-2 py-0.5 bg-orange-50 rounded-md">문장 {{ index + 1 }}</span>
    ...
    <div v-if="selectedSample" class="fixed inset-0 z-50 flex items-end">
      ...
      <div class="relative w-full bg-white rounded-t-[2.5rem] p-8 pb-12 animate-slide-up">
        ...
        <div class="flex items-center justify-center gap-6">
          ...
          <button v-if="!isRecording && selectedSample.isRecorded" class="w-14 h-14 rounded-full bg-green-50 text-green-600 flex items-center justify-center">
