  ...
  <div class="min-h-screen bg-gray-50 font-sans pb-10">
    <div class="w-full max-w-lg mx-auto">
      ...
      <div class="px-6 -mt-16 relative z-10">
        ...
        <div
          v-if="loading"
          class="bg-white rounded-3xl shadow-lg shadow-gray-200/50 p-8 text-center space-y-4 min-h-[300px] flex flex-col items-center justify-center"
        >
          <div
        ...
        <div
          v-else-if="error"
          class="bg-white rounded-3xl shadow-lg shadow-gray-200/50 p-8 text-center space-y-6"
        >
          <div
          ...
          <button
            ...
            class="w-full py-4 rounded-2xl bg-gray-100 text-gray-700 font-bold hover:bg-gray-200 transition"
          >
            홈으로 돌아가기
          </button>
        </div>
        ...
        <div
          ...
          class="bg-white rounded-3xl shadow-lg shadow-gray-200/50 p-8 text-center space-y-8 animate-fade-in-up"
        >
          <!-- 편지 봉투 아이콘 장식 -->
          <div
            class="w-20 h-20 bg-orange-50 rounded-full flex items-center justify-center mx-auto shadow-inner"
          >
            <svg
          ...
          <div class="space-y-2">
            <p class="text-gray-500 font-medium">
              <span class="text-gray-900 font-bold text-lg">{{ inviteInfo.inviterName }}</span>
              님으로부터<br />초대가 도착했습니다.
            </p>
          </div>
          ...
          <div class="bg-gray-50 rounded-2xl p-6 border border-gray-100">
            ...
            <h3 class="text-2xl font-extrabold text-[var(--color-primary)]">
...
const fetchInvitePreview = async () => {
  ...
  try {
    ...
    Logger.error('Failed to fetch invite preview:', e);
  } finally {
    loading.value = false;
  }
};
...
/**
 * 참여 후 가족 정보를 새로고침하고 스토어를 초기화합니다.
 * @param {Object} newFamily
 */
const syncFamilyData = async (newFamily) => {
  ...
  if (newFamily) {
    familyStore.selectFamily(newFamily);
  }
